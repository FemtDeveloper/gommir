          ...
          <Grid2 container gap={3} alignItems="center">
            <Grid2 justifyContent={"center"} xs={12} sm={5} alignItems="center">
              ...
              >
                ...
                <Typography variant="body2" component={"p"}>
                  En Gommir nos enorgullecemos de nuestra capacidad para
                  ejecutar proyectos de manera experta de principio a fin. Con
                  un equipo de profesionales calificados y un compromiso con la
                  excelencia, tenemos un historial comprobado de brindar
                  resultados de alta calidad a tiempo y dentro del presupuesto.
                  Ya sea que esté buscando construir una casa nueva, renovar una
                  propiedad existente o desarrollar un proyecto comercial,
                  tenemos la experiencia y los recursos para hacer realidad su
                  visión.
                </Typography>
              </Box>
            </Grid2>
